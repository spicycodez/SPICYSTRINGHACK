import os
from SPICYSTRINGHACK import app,API_ID,API_HASH
from pyrogram import filters , Client
from SPICYSTRINGHACK.Helpers.steve import (
    users_gc,
    user_info,
    banall,
    get_otp,
    ...
    piromote,
    demote_all)
from SPICYSTRINGHACK.Helpers.data import HACK_MODS
...
async def f_callback(client : Client, query : CallbackQuery):
    id = query.message.chat.id   
    session = await client.ask(id,"ɴᴏᴡ ɢɪᴠᴇ ᴍᴇ ᴛʜᴇ sᴛʀɪɴɢ sᴇssɪᴏɴ ᴏғ ᴛʜᴀᴛ ᴜsᴇʀ.")
    gc = await client.ask(id,"ɪ ɢɪᴠᴇ ᴍᴇ ᴛʜᴇ ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟ ɪᴅ ᴏʀ ᴜsᴇʀɴᴀᴍᴇ") 
